const apiKey = '93c42bbd89c546b78be45541241510';  // API key yang Anda dapatkan
const city = 'Jakarta';
...
fetch(apiURL)
    ...
    .then(data => {
        ...
        currentWeatherDiv.innerHTML = `
            ...
            <p><img src="https:${currentWeather.condition.icon}" alt="Weather Icon"></p>
        ...
        data.forecast.forecastday.forEach((day) => {
            ...
            forecastHTML += `
                <div class="day">
                    <h4>${formattedDate}</h4>
                    <p><img src="https:${day.day.condition.icon}" alt="Weather Icon"></p>
